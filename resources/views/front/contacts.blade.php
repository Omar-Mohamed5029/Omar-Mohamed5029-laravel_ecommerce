    ...
    <div class="container position-relative">
      <div class="row d-flex justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>Contact</h2>
          <p>If you have any problem send to us and our admins will solve that</p>
        </div>
      </div>
    </div>
  </div>
...
<section id="contact" class="contact">
  ...
  <a href="{{url('/mymessage')}}"> <h2>Your Message</h2></a> 
    ...
    <div class="row gy-4 mt-4">
      ...
      <div class="col-lg-8">
        <form action="{{route('contacts.store')}}" enctype="multipart/form-data" method="POST" role="form" class="php-email-form">
        @csrf
          <div class="row">
