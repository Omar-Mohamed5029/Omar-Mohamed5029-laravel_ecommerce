...
<main id="main">
    ...
    <form action="{{route('alloffers.store')}}"  method="POST" enctype="multipart/form-data">
    @csrf
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Product offer</label>
    <input type="num" name ="offer_percentage" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <br>
  <br>
...
<div class="mb-3">
  <label for="formFile" class="form-label">uplaod main image</label>
